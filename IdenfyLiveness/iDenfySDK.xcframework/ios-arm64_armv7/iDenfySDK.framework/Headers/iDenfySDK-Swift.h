...
SWIFT_CLASS("_TtC9iDenfySDK34FaceReauthenticationInitialization")
@interface FaceReauthenticationInitialization : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

enum FaceReauthenticationStatus : NSInteger;

/// Stores FaceReauthenticationStatus
SWIFT_CLASS("_TtC9iDenfySDK26FaceReauthenticationResult")
@interface FaceReauthenticationResult : NSObject
@property (nonatomic, readonly) enum FaceReauthenticationStatus faceReauthenticationStatus;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Returns face reauthentication status.
typedef SWIFT_ENUM(NSInteger, FaceReauthenticationStatus, open) {
/// The user completed a face reauthentication flow and the reauthentication status, provided by the platform, is SUCCESS.
  FaceReauthenticationStatusSUCCESS = 0,
/// The user completed a face reauthentication flow and the reauthentication status, provided by the platform, is FAILED.
  FaceReauthenticationStatusFAILED = 1,
/// The user did not complete a face reauthentication flow and the reauthentication status, provided by the platform, is EXIT.
  FaceReauthenticationStatusEXIT = 2,
};
...
@property (nonatomic, copy) void (^ _Nullable idenfyFaceReauthenticationResultCallback)(FaceReauthenticationResult * _Nonnull);
...
/// Returns user’s face reauthentication result
/// \param idenfyIdentificationResult A callback for receiving result.
///
- (void)handleIdenfyCallbacksForFaceReauthenticationWithFaceReauthenticationResult:(void (^ _Nonnull)(FaceReauthenticationResult * _Nonnull))faceReauthenticationResult;
...
/// Initializes iDenfySDK Face Reauthentication, instantiateNavigationController() should be called next.
/// \param faceReauthenticationInitialization Used for providing face reauthentication information.
///
/// \param idenfyViewsV2 Used for setting custom identification UI.
///
- (void)initializeFaceReauthenticationWithFaceReauthenticationInitialization:(FaceReauthenticationInitialization * _Nonnull)faceReauthenticationInitialization;
/// Initializes  iDenfySDK Face Reauthentication, instantiateNavigationController() should be called next.
/// \param faceReauthenticationInitialization Used for providing face reauthentication information.
///
/// \param idenfyViewsV2 Used for setting custom identification UI.
///
- (void)initializeFaceReauthenticationWithFaceReauthenticationInitialization:(FaceReauthenticationInitialization * _Nonnull)faceReauthenticationInitialization idenfyViewsV2:(IdenfyViewsV2 * _Nonnull)idenfyViewsV2;
...
SWIFT_CLASS("_TtC9iDenfySDK46IdenfyFaceReauthenticationNavigationController")
@interface IdenfyFaceReauthenticationNavigationController : IdenfySDKNavigationController
...
/// Shows an onBoarding view before EVERY step of the verification process (This is a default setting starting 7.x version)
  IdenfyOnBoardingViewTypeEnumMultiple = 1,
/// Does not show any onBoarding view
  IdenfyOnBoardingViewTypeEnumNone = 2,
};
